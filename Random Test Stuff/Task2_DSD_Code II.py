    ...
    while end_transaction == False:
        ...
        while valid_price == False:
            ...
            if temp_price.lower() == "x":
                ...
                try:
                    if(temp_price.lower() == "inf"):
                        raise(ValueError)
                    elif(float(temp_price) < 0):
                        raise(ValueError)
                    elif(float(temp_price) > 1000000):
                        raise(ValueError)
                    elif(float(temp_price) > 100000):
                        print("This item costs over £100,000! Are you sure its price was entered correctly?")
                except:
